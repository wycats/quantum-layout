...
const ENV = Environment.default("\u{1f9d9}").icon("page", "\u{1f4c3}").icon("state:pending", "\u231b").icon("state:update", "\u{1f440}").icon("state:active", "\u2705").icon("state:done", "\u{1f3c1}").icon("state:error", "\u26d4").icon("state:reload", "\u{1f504}").icon("state:transition", "\u231b").enable("state:transition");
